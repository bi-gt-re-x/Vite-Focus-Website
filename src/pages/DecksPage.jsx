      ...
      <div className="app" data-collapsed="false">
        <aside className="sidebar">
          ...
          <nav className="sidebar__nav">
            <a className="nav-link" href="home.html" data-page="home"><svg className="nav-link__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 10.5 12 3l9 7.5V20a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1z"/></svg><span>Home</span></a>
            <a className="nav-link" href="timer.html" data-page="timer"><svg className="nav-link__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><circle cx="12" cy="12" r="8"/><path d="M12 8v4l2.5 2.5"/></svg><span>Timer</span></a>
            ...
            <a className="nav-link" href="study.html" data-page="study"><svg className="nav-link__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="M8 10h8M8 14h5"/></svg><span>Study</span></a>
            <a className="nav-link" href="stats.html" data-page="stats"><svg className="nav-link__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M5 20V10M12 20V4M19 20v-7"/></svg><span>Stats</span></a>
            <a className="nav-link" href="settings.html" data-page="settings"><svg className="nav-link__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M4 7h10M18 7h2M4 17h4M12 17h8"/><circle cx="16" cy="7" r="2"/><circle cx="10" cy="17" r="2"/></svg><span>Settings</span></a>
          </nav>
            ...
            <section className="deck-grid">
              <article className="deck-card" style={{ '--deck-color': '#e5b53a' }}>
                ...
                <div className="deck-card__actions">
                  <a className="btn btn--primary btn--sm grow" href="study.html">Study</a>
